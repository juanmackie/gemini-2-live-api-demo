 ...
 */
let GdmLiveAudioVisuals3D = class GdmLiveAudioVisuals3D extends LitElement {
    constructor() {
        super(...arguments);
        this.prevTime = 0;
    ...
    init() {
        ...
        const backdrop = new THREE.Mesh(new THREE.IcosahedronGeometry(10, 5), new THREE.RawShaderMaterial({
            uniforms: {
        ...
        new EXRLoader().load('/public/piz_compressed.exr', (texture) => {
...
GdmLiveAudioVisuals3D.styles = css `
    canvas {
      width: 100% !important;
...
__decorate([
    property()
], GdmLiveAudioVisuals3D.prototype, "outputNode", null);
__decorate([
    property()
], GdmLiveAudioVisuals3D.prototype, "inputNode", null);
GdmLiveAudioVisuals3D = __decorate([
    customElement('gdm-live-audio-visuals-3d')
], GdmLiveAudioVisuals3D);
export { GdmLiveAudioVisuals3D };
//# sourceMappingURL=visual-3d.js.map